---
title: \Leantime\Domain\Api\Controllers\ApiKey
footer: false
---
...
```php
public ApiKey::init(\Leantime\Domain\Projects\Repositories\Projects $projectsRepo, \Leantime\Domain\Users\Repositories\Users $userRepo, \Leantime\Domain\Clients\Repositories\Clients $clientsRepo): void
```
...
```php
public ApiKey::run(): \Symfony\Component\HttpFoundation\Response
```
