---
title: \Leantime\Domain\Api\Controllers\DelAPIKey
footer: false
---
...
```php
public DelAPIKey::init(\Leantime\Domain\Api\Services\Api $APIService, \Leantime\Domain\Users\Repositories\Users $userRepo): void
```
...
```php
public DelAPIKey::run(): \Symfony\Component\HttpFoundation\RedirectResponse|\Symfony\Component\HttpFoundation\Response
```
