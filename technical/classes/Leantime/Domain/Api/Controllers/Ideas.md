...
```php
public Ideas::init(\Leantime\Domain\Projects\Repositories\Projects $projects, \Leantime\Domain\Ideas\Repositories\Ideas $ideaAPIRepo): void
```
...
```php
public Ideas::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Ideas::post(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Ideas::patch(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Ideas::delete(array $params): \Symfony\Component\HttpFoundation\Response
```
