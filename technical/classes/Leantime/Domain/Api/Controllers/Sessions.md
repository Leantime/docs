...
`\Leantime\Domain\Api\Controllers\Sessions`
...
```php
public Sessions::init(\Leantime\Domain\Users\Services\Users $userService, \Leantime\Domain\Menu\Repositories\Menu $menu): void
```
...
```php
public Sessions::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Sessions::post(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Sessions::patch(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Sessions::delete(array $params): \Symfony\Component\HttpFoundation\Response
```
