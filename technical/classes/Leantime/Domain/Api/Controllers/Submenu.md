...
```php
public Submenu::init(\Leantime\Domain\Menu\Repositories\Menu $menu): mixed
```
...
```php
public Submenu::get(mixed $params): mixed
```
...
```php
public Submenu::post(mixed $params): mixed
```
...
```php
public Submenu::patch(mixed $params): mixed
```
...
```php
public Submenu::delete(mixed $params): mixed
```
