...
```php
public Timer::init(\Leantime\Domain\Timesheets\Services\Timesheets $timesheetService): mixed
```
...
```php
public Timer::get(mixed $params): mixed
```
...
```php
public Timer::post(mixed $params): mixed
```
