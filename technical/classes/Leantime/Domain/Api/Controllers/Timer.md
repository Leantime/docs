---
title: \Leantime\Domain\Api\Controllers\Timer
footer: false
---
...
* Full name: `\Leantime\Domain\Api\Controllers\Timer`
...
```php
public Timer::init(\Leantime\Domain\Timesheets\Services\Timesheets $timesheetService): void
```
...
```php
public Timer::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Timer::post(array $params): \Symfony\Component\HttpFoundation\Response
```
