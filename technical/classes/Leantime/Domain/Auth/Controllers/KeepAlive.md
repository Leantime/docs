---
title: \Leantime\Domain\Auth\Controllers\KeepAlive
footer: false
---
...
* Full name: `\Leantime\Domain\Auth\Controllers\KeepAlive`
...
```php
public KeepAlive::init(\Leantime\Domain\Auth\Services\Auth $authService): void
```
...
```php
public KeepAlive::get(array $params): \Symfony\Component\HttpFoundation\Response
```
