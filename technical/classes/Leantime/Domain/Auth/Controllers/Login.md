---
title: \Leantime\Domain\Auth\Controllers\Login
footer: false
---
...
* Full name: `\Leantime\Domain\Auth\Controllers\Login`
...
```php
public Login::init(\Leantime\Domain\Auth\Services\Auth $authService, \Leantime\Core\Configuration\Environment $config): void
```
...
```php
public Login::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Login::post(array $params): \Symfony\Component\HttpFoundation\Response
```
