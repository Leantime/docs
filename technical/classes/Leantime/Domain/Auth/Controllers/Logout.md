---
title: \Leantime\Domain\Auth\Controllers\Logout
footer: false
---
...
* Full name: `\Leantime\Domain\Auth\Controllers\Logout`
...
```php
public Logout::init(\Leantime\Domain\Auth\Services\Auth $authService): void
```
...
```php
public Logout::get(array $params): \Symfony\Component\HttpFoundation\Response
```
