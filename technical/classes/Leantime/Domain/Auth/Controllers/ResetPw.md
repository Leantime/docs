...
```php
public ResetPw::init(\Leantime\Domain\Files\Repositories\Files $fileRepo, \Leantime\Domain\Auth\Services\Auth $authService, \Leantime\Domain\Users\Services\Users $usersService): mixed
```
...
```php
public ResetPw::get(mixed $params): mixed
```
...
```php
public ResetPw::post(mixed $params): mixed
```
