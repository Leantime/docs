---
title: \Leantime\Domain\Auth\Controllers\ResetPw
footer: false
---
...
```php
public ResetPw::init(\Leantime\Domain\Files\Repositories\Files $fileRepo, \Leantime\Domain\Auth\Services\Auth $authService, \Leantime\Domain\Users\Services\Users $userService): void
```
...
```php
public ResetPw::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public ResetPw::post(array $params): \Symfony\Component\HttpFoundation\Response
```
