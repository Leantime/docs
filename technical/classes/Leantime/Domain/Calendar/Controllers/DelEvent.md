---
title: \Leantime\Domain\Calendar\Controllers\DelEvent
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\DelEvent`
...
```php
public DelEvent::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): void
```
...
```php
public DelEvent::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public DelEvent::post(array $params): \Symfony\Component\HttpFoundation\Response
```
