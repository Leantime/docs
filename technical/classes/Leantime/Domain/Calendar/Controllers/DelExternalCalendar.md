---
title: \Leantime\Domain\Calendar\Controllers\DelExternalCalendar
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\DelExternalCalendar`
...
```php
public DelExternalCalendar::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): void
```
...
```php
public DelExternalCalendar::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public DelExternalCalendar::post(array $params): \Symfony\Component\HttpFoundation\Response
```
