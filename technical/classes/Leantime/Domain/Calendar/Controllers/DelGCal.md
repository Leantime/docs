---
title: \Leantime\Domain\Calendar\Controllers\DelGCal
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\DelGCal`
...
```php
public DelGCal::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): mixed
```
