---
title: \Leantime\Domain\Calendar\Controllers\EditEvent
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\EditEvent`
...
```php
public EditEvent::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): void
```
...
```php
public EditEvent::get(array $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public EditEvent::post(array $params): \Symfony\Component\HttpFoundation\Response
```
