...
```php
public EditEvent::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): mixed
```
...
```php
public EditEvent::get(mixed $params): mixed
```
...
```php
public EditEvent::post(mixed $params): mixed
```
