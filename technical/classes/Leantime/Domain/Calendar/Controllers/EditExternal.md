---
title: \Leantime\Domain\Calendar\Controllers\EditExternal
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\EditExternal`
...
```php
public EditExternal::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): void
```
...
```php
public EditExternal::run(): \Symfony\Component\HttpFoundation\Response
```
