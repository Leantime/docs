---
title: \Leantime\Domain\Calendar\Controllers\EditGCal
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\EditGCal`
...
```php
public EditGCal::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): mixed
```
