---
title: \Leantime\Domain\Calendar\Controllers\ExternalCal
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\ExternalCal`
...
```php
public ExternalCal::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): void
```
...
```php
private ExternalCal::loadIcalUrl(string $url): string
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `url` | **string** | The URL of the iCal to load. |
