---
title: \Leantime\Domain\Calendar\Controllers\Ical
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\Ical`
...
```php
public Ical::init(\Leantime\Domain\Calendar\Services\Calendar $calendarService): void
```
...
```php
public Ical::run(): \Symfony\Component\HttpFoundation\RedirectResponse|\Symfony\Component\HttpFoundation\Response
```
