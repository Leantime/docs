---
title: \Leantime\Domain\Calendar\Controllers\ImportGCal
footer: false
---
...
```php
public ImportGCal::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): void
```
...
```php
public ImportGCal::run(): \Symfony\Component\HttpFoundation\Response
```
