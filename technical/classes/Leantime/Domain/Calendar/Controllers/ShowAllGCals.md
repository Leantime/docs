---
title: \Leantime\Domain\Calendar\Controllers\ShowAllGCals
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\ShowAllGCals`
...
```php
public ShowAllGCals::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): void
```
...
```php
public ShowAllGCals::run(): \Symfony\Component\HttpFoundation\Response
```
