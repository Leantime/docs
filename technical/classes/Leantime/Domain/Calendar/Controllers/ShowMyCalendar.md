---
title: \Leantime\Domain\Calendar\Controllers\ShowMyCalendar
footer: false
---
...
```php
public ShowMyCalendar::init(\Leantime\Domain\Calendar\Repositories\Calendar $calendarRepo): void
```
...
```php
public ShowMyCalendar::run(): \Symfony\Component\HttpFoundation\Response
```
