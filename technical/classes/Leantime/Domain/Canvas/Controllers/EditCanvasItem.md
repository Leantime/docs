---
title: \Leantime\Domain\Canvas\Controllers\EditCanvasItem
footer: false
---
...
* Full name: `\Leantime\Domain\Canvas\Controllers\EditCanvasItem`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Domain\Canvas\Controllers\EditCanvasItem::CANVAS_NAME`|string|&#039;??&#039;|
...
```php
public EditCanvasItem::__construct(\Leantime\Core\Http\IncomingRequest $incomingRequest, \Leantime\Core\Template $tpl, \Leantime\Core\Language $language): mixed
```
