---
title: \Leantime\Domain\Clients\Controllers\NewClient
footer: false
---
...
* Full name: `\Leantime\Domain\Clients\Controllers\NewClient`
...
```php
public NewClient::init(\Leantime\Domain\Clients\Repositories\Clients $clientRepo, \Leantime\Domain\Users\Repositories\Users $user): mixed
```
...
| `user` | **\Leantime\Domain\Users\Repositories\Users** |  |
