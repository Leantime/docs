---
title: \Leantime\Domain\Comments\Controllers\ShowAll
footer: false
---
...
* Full name: `\Leantime\Domain\Comments\Controllers\ShowAll`
...
```php
public ShowAll::init(\Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Domain\Comments\Services\Comments $commentService): void
```
