...
`\Leantime\Domain\Connector\Controllers\Integration`
...
```php
public Integration::init(\Leantime\Domain\Connector\Services\Providers $providerService, \Leantime\Domain\Connector\Services\Integrations $integrationService, \Leantime\Domain\Connector\Repositories\LeantimeEntities $leantimeEntities, \Leantime\Domain\Connector\Services\Connector $connectorService): mixed
```
...
| `connectorService` | **\Leantime\Domain\Connector\Services\Connector** |  |
