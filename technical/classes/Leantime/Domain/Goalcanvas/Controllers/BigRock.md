---
title: \Leantime\Domain\Goalcanvas\Controllers\BigRock
footer: false
---
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Domain\Goalcanvas\Controllers\BigRock::CANVAS_NAME`|string|&#039;goal&#039;|
...
```php
public BigRock::get(mixed $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public BigRock::post(mixed $params): \Symfony\Component\HttpFoundation\Response
```
