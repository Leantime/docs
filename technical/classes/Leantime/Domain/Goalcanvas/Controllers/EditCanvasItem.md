---
title: \Leantime\Domain\Goalcanvas\Controllers\EditCanvasItem
footer: false
---
...
* Full name: `\Leantime\Domain\Goalcanvas\Controllers\EditCanvasItem`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Domain\Goalcanvas\Controllers\EditCanvasItem::CANVAS_NAME`|string|&#039;goal&#039;|
...
```php
public EditCanvasItem::get(mixed $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public EditCanvasItem::post(mixed $params): \Symfony\Component\HttpFoundation\Response
```
