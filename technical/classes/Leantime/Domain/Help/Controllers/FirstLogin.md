---
title: \Leantime\Domain\Help\Controllers\FirstLogin
footer: false
---
...
* Full name: `\Leantime\Domain\Help\Controllers\FirstLogin`
...
```php
public FirstLogin::get(mixed $params): mixed
```
...
```php
public FirstLogin::post(mixed $params): mixed
```
