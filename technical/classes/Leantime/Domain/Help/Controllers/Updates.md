---
title: \Leantime\Domain\Help\Controllers\Updates
footer: false
---
...
* Full name: `\Leantime\Domain\Help\Controllers\Updates`
...
```php
public Updates::get(mixed $params): mixed
```
...
```php
public Updates::post(mixed $params): mixed
```
...
```php
public Updates::put(mixed $params): mixed
```
...
```php
public Updates::delete(mixed $params): mixed
```
