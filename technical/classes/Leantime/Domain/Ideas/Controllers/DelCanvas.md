---
title: \Leantime\Domain\Ideas\Controllers\DelCanvas
footer: false
---
...
* Full name: `\Leantime\Domain\Ideas\Controllers\DelCanvas`
...
```php
public DelCanvas::init(\Leantime\Domain\Ideas\Repositories\Ideas $ideaRepo): mixed
```
