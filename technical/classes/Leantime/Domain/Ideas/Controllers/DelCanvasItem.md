---
title: \Leantime\Domain\Ideas\Controllers\DelCanvasItem
footer: false
---
...
* Full name: `\Leantime\Domain\Ideas\Controllers\DelCanvasItem`
...
```php
public DelCanvasItem::init(\Leantime\Domain\Ideas\Repositories\Ideas $ideasRepo): mixed
```
...
|-----------|------|-------------|
| `ideasRepo` | **\Leantime\Domain\Ideas\Repositories\Ideas** |  |
