---
title: \Leantime\Domain\Ideas\Controllers\ShowBoards
footer: false
---
...
* Full name: `\Leantime\Domain\Ideas\Controllers\ShowBoards`
...
```php
public ShowBoards::init(\Leantime\Domain\Ideas\Repositories\Ideas $ideaRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
