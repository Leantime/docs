---
title: \Leantime\Domain\Install\Controllers\Index
footer: false
---
...
* Full name: `\Leantime\Domain\Install\Controllers\Index`
...
```php
public Index::init(\Leantime\Domain\Install\Repositories\Install $installRepo): mixed
```
...
```php
public Index::post( $params): \Symfony\Component\HttpFoundation\Response
```
