...
`\Leantime\Domain\Install\Controllers\Update`
...
```php
public Update::init(\Leantime\Domain\Install\Repositories\Install $installRepo, \Leantime\Domain\Setting\Repositories\Setting $settingsRepo, \Leantime\Core\Configuration\AppSettings $appSettings): mixed
```
...
```php
public Update::post( $params): \Symfony\Component\HttpFoundation\Response
```
