---
title: \Leantime\Domain\Notifications\Hxcontrollers\News
footer: false
---
...
* Full name: `\Leantime\Domain\Notifications\Hxcontrollers\News`
...
```php
public News::init(\Leantime\Domain\Notifications\Services\News $newsService): void
```
