---
title: \Leantime\Domain\Oidc\Controllers\Callback
footer: false
---
...
```php
public Callback::init(\Leantime\Domain\Oidc\Services\Oidc $oidc): void
```
...
```php
public Callback::get( $params): \Symfony\Component\HttpFoundation\Response
```
