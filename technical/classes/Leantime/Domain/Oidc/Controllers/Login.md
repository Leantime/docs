---
title: \Leantime\Domain\Oidc\Controllers\Login
footer: false
---
...
* Full name: `\Leantime\Domain\Oidc\Controllers\Login`
...
```php
public Login::init(\Leantime\Domain\Oidc\Services\Oidc $oidc): void
```
...
|-----------|------|-------------|
| `oidc` | **\Leantime\Domain\Oidc\Services\Oidc** |  |
...
```php
public Login::run(): \Symfony\Component\HttpFoundation\Response
```
