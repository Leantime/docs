---
title: \Leantime\Domain\Plugins\Controllers\CssLoader
footer: false
---
...
* Full name: `\Leantime\Domain\Plugins\Controllers\CssLoader`
...
```php
public CssLoader::init(\Leantime\Domain\Plugins\Services\Plugins $pluginService): void
```
...
```php
public CssLoader::get(): \Symfony\Component\HttpFoundation\Response
```
