---
title: \Leantime\Domain\Plugins\Controllers\Details
footer: false
---
...
* Full name: `\Leantime\Domain\Plugins\Controllers\Details`
...
```php
public Details::init(\Leantime\Domain\Plugins\Services\Plugins $pluginService): void
```
...
```php
public Details::get(): \Symfony\Component\HttpFoundation\Response
```
