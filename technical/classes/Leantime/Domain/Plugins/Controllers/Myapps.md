---
title: \Leantime\Domain\Plugins\Controllers\Myapps
footer: false
---
...
* Full name: `\Leantime\Domain\Plugins\Controllers\Myapps`
...
```php
public Myapps::init(\Leantime\Domain\Plugins\Services\Plugins $pluginService): void
```
...
```php
public Myapps::get(): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Myapps::post( $params): \Symfony\Component\HttpFoundation\Response
```
