...
`\Leantime\Domain\Plugins\Services\Plugins`
...
```php
public Plugins::__construct(\Leantime\Domain\Plugins\Repositories\Plugins $pluginRepository, \Leantime\Core\Configuration\Environment $config, \Leantime\Domain\Setting\Services\Setting $settingsService, \Leantime\Domain\Users\Services\Users $usersService): void
```
...
```php
public Plugins::isEnabled( $pluginFolder): bool
```
