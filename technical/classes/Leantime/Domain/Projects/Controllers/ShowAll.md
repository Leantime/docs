---
title: \Leantime\Domain\Projects\Controllers\ShowAll
footer: false
---
...
* Full name: `\Leantime\Domain\Projects\Controllers\ShowAll`
...
```php
public ShowAll::init(\Leantime\Domain\Projects\Repositories\Projects $projectRepo, \Leantime\Domain\Menu\Repositories\Menu $menuRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
