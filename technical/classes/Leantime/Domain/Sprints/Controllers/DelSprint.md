---
title: \Leantime\Domain\Sprints\Controllers\DelSprint
footer: false
---
...
* Full name: `\Leantime\Domain\Sprints\Controllers\DelSprint`
...
```php
public DelSprint::init(\Leantime\Domain\Sprints\Repositories\Sprints $sprintRepo): mixed
```
...
|-----------|------|-------------|
| `sprintRepo` | **\Leantime\Domain\Sprints\Repositories\Sprints** |  |
