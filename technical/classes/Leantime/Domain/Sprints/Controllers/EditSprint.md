---
title: \Leantime\Domain\Sprints\Controllers\EditSprint
footer: false
---
...
```php
public EditSprint::init(\Leantime\Domain\Sprints\Services\Sprints $sprintService, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
...
```php
public EditSprint::get(mixed $params): mixed
```
...
```php
public EditSprint::post(mixed $params): mixed
```
...
```php
public EditSprint::put(mixed $params): mixed
```
...
```php
public EditSprint::delete(mixed $params): mixed
```
