---
title: \Leantime\Domain\Strategy\Controllers\ShowBoards
footer: false
---
...
* Full name: `\Leantime\Domain\Strategy\Controllers\ShowBoards`
...
```php
public ShowBoards::init(\Leantime\Domain\Canvas\Services\Canvas $canvasService): void
```
...
|-----------|------|-------------|
| `canvasService` | **\Leantime\Domain\Canvas\Services\Canvas** |  |
...
```php
public ShowBoards::run(): \Symfony\Component\HttpFoundation\Response
```
