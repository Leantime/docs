---
title: \Leantime\Domain\Tickets\Controllers\DelMilestone
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Controllers\DelMilestone`
...
```php
public DelMilestone::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService): void
```
...
```php
public DelMilestone::get(): \Symfony\Component\HttpFoundation\Response
```
...
```php
public DelMilestone::post( $params): \Symfony\Component\HttpFoundation\Response
```
