---
title: \Leantime\Domain\Tickets\Controllers\DelTicket
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Controllers\DelTicket`
...
```php
public DelTicket::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService): void
```
...
```php
public DelTicket::get(): \Symfony\Component\HttpFoundation\Response
```
...
```php
public DelTicket::post( $params): \Symfony\Component\HttpFoundation\Response
```
