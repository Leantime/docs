---
title: \Leantime\Domain\Tickets\Controllers\EditMilestone
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Controllers\EditMilestone`
...
```php
public EditMilestone::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Domain\Comments\Services\Comments $commentsService, \Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Domain\Tickets\Repositories\Tickets $ticketRepo, \Leantime\Domain\Projects\Repositories\Projects $projectRepo): mixed
```
