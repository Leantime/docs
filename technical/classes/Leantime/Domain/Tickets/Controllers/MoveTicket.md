...
`\Leantime\Domain\Tickets\Controllers\MoveTicket`
...
```php
public MoveTicket::get( $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public MoveTicket::post( $params): \Symfony\Component\HttpFoundation\Response
```
