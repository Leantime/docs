---
title: \Leantime\Domain\Tickets\Controllers\NewTicket
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Controllers\NewTicket`
...
```php
public NewTicket::get(): \Symfony\Component\HttpFoundation\Response
```
...
```php
public NewTicket::post( $params): \Symfony\Component\HttpFoundation\Response
```
