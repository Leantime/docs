---
title: \Leantime\Domain\Tickets\Controllers\ShowAllMilestones
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Controllers\ShowAllMilestones`
...
```php
public ShowAllMilestones::init(\Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Domain\Sprints\Services\Sprints $sprintService, \Leantime\Domain\Timesheets\Services\Timesheets $timesheetService): void
```
...
```php
public ShowAllMilestones::get( $params): \Symfony\Component\HttpFoundation\Response
```
