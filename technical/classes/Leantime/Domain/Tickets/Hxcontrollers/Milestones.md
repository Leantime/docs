---
title: \Leantime\Domain\Tickets\Hxcontrollers\Milestones
footer: false
---
...
* Full name: `\Leantime\Domain\Tickets\Hxcontrollers\Milestones`
...
```php
public Milestones::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Core\Language $language): void
```
...
```php
public Milestones::progress(): mixed
```
...
```php
public Milestones::showCard(): mixed
```
