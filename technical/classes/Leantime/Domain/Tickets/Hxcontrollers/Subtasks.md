---
title: \Leantime\Domain\Tickets\Hxcontrollers\Subtasks
footer: false
---
...
```php
public Subtasks::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Core\Language $language): void
```
