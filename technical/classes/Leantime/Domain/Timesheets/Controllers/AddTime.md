---
title: \Leantime\Domain\Timesheets\Controllers\AddTime
footer: false
---
...
```php
public AddTime::init(\Leantime\Domain\Timesheets\Repositories\Timesheets $timesheetsRepo, \Leantime\Domain\Projects\Repositories\Projects $projects, \Leantime\Domain\Tickets\Repositories\Tickets $tickets): void
```
...
```php
public AddTime::run(): \Symfony\Component\HttpFoundation\Response
```
