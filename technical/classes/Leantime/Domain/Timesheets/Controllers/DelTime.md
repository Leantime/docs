---
title: \Leantime\Domain\Timesheets\Controllers\DelTime
footer: false
---
...
* Full name: `\Leantime\Domain\Timesheets\Controllers\DelTime`
...
```php
public DelTime::init(\Leantime\Domain\Timesheets\Repositories\Timesheets $timesheetsRepo): void
```
...
```php
public DelTime::run(): \Symfony\Component\HttpFoundation\Response|\Illuminate\Http\RedirectResponse
```
