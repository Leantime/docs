---
title: \Leantime\Domain\Timesheets\Controllers\ShowMyList
footer: false
---
...
* Full name: `\Leantime\Domain\Timesheets\Controllers\ShowMyList`
...
```php
public ShowMyList::init(\Leantime\Domain\Timesheets\Services\Timesheets $timesheetService): void
```
...
```php
public ShowMyList::run(): \Symfony\Component\HttpFoundation\Response
```
