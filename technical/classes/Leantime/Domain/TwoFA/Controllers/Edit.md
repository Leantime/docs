---
title: \Leantime\Domain\TwoFA\Controllers\Edit
footer: false
---
...
```php
public Edit::init(\Leantime\Domain\Users\Repositories\Users $userRepo): void
```
...
```php
public Edit::run(): \Symfony\Component\HttpFoundation\Response
```
