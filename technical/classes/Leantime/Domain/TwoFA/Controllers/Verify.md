---
title: \Leantime\Domain\TwoFA\Controllers\Verify
footer: false
---
...
```php
public Verify::init(\Leantime\Domain\Auth\Services\Auth $authService): mixed
```
...
```php
public Verify::get(mixed $params): mixed
```
...
```php
public Verify::post( $params): \Symfony\Component\HttpFoundation\Response
```
