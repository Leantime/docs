---
title: \Leantime\Domain\Users\Controllers\Import
footer: false
---
...
* Full name: `\Leantime\Domain\Users\Controllers\Import`
...
```php
public Import::init(\Leantime\Domain\Users\Repositories\Users $userRepo, \Leantime\Domain\Ldap\Services\Ldap $ldapService): void
```
...
```php
public Import::get(): \Symfony\Component\HttpFoundation\Response
```
...
```php
public Import::post( $params): \Symfony\Component\HttpFoundation\Response
```
