---
title: \Leantime\Domain\Widgets\Hxcontrollers\MyToDos
footer: false
---
...
```php
public MyToDos::init(\Leantime\Domain\Tickets\Services\Tickets $ticketsService, \Leantime\Core\Language $language): void
```
