---
title: \Leantime\Domain\Wiki\Controllers\ArticleDialog
footer: false
---
...
* Full name: `\Leantime\Domain\Wiki\Controllers\ArticleDialog`
...
```php
public ArticleDialog::init(\Leantime\Domain\Wiki\Services\Wiki $wikiService, \Leantime\Domain\Tickets\Services\Tickets $ticketService): void
```
...
```php
public ArticleDialog::get( $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public ArticleDialog::post( $params): \Symfony\Component\HttpFoundation\Response
```
