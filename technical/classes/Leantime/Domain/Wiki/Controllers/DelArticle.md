---
title: \Leantime\Domain\Wiki\Controllers\DelArticle
footer: false
---
...
```php
public DelArticle::init(\Leantime\Domain\Wiki\Repositories\Wiki $wikiRepo): mixed
```
