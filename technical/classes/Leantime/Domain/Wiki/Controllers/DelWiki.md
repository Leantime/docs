---
title: \Leantime\Domain\Wiki\Controllers\DelWiki
footer: false
---
...
* Full name: `\Leantime\Domain\Wiki\Controllers\DelWiki`
...
```php
public DelWiki::init(\Leantime\Domain\Wiki\Repositories\Wiki $wikiRepo): mixed
```
