...
```php
public Show::init(\Leantime\Domain\Wiki\Services\Wiki $wikiService, \Leantime\Domain\Comments\Services\Comments $commentService): void
```
...
```php
public Show::get( $params): \Symfony\Component\HttpFoundation\Response
```
