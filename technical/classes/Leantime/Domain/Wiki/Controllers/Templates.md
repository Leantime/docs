---
title: \Leantime\Domain\Wiki\Controllers\Templates
footer: false
---
...
* Full name: `\Leantime\Domain\Wiki\Controllers\Templates`
...
```php
public Templates::get( $params): \Symfony\Component\HttpFoundation\Response
```
