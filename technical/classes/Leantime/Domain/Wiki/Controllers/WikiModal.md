...
```php
public WikiModal::init(\Leantime\Domain\Wiki\Services\Wiki $wikiService): void
```
...
```php
public WikiModal::get( $params): \Symfony\Component\HttpFoundation\Response
```
...
```php
public WikiModal::post( $params): \Symfony\Component\HttpFoundation\Response
```
