---
title: \Leantime\Plugins\Accounts\Controllers\Newteam
footer: false
---
...
* Full name: `\Leantime\Plugins\Accounts\Controllers\Newteam`
...
```php
public Newteam::get(mixed $params): mixed
```
...
```php
public Newteam::post(mixed $params): mixed
```
