---
title: \Leantime\Plugins\Accounts\Controllers\Register
footer: false
---
...
* Full name: `\Leantime\Plugins\Accounts\Controllers\Register`
...
```php
public Register::init(\Leantime\Domain\Install\Repositories\Install $installRepo): mixed
```
...
```php
public Register::get(mixed $params): mixed
```
...
```php
public Register::post(mixed $params): mixed
```
