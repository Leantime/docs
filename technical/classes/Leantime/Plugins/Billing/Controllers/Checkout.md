---
title: \Leantime\Plugins\Billing\Controllers\Checkout
footer: false
---
...
* Full name: `\Leantime\Plugins\Billing\Controllers\Checkout`
...
```php
public Checkout::init(\Leantime\Plugins\Billing\Services\Billing $billingService, \Leantime\Domain\Projects\Repositories\Projects $projectRepository, \Leantime\Core\Environment $config): mixed
```
...
```php
public Checkout::get(mixed $params): mixed
```
...
```php
public Checkout::post(mixed $params): mixed
```
...
```php
public Checkout::put(mixed $params): mixed
```
...
```php
public Checkout::delete(mixed $params): mixed
```
