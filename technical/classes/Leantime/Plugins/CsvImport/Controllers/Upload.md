---
title: \Leantime\Plugins\CsvImport\Controllers\Upload
footer: false
---
...
* Full name: `\Leantime\Plugins\CsvImport\Controllers\Upload`
...
```php
public Upload::init(\Leantime\Plugins\CsvImport\Services\CsvImport $providerService): void
```
...
|-----------|------|-------------|
| `providerService` | **\Leantime\Plugins\CsvImport\Services\CsvImport** |  |
...
```php
public Upload::post(array $params): void
```
