---
title: \Leantime\Plugins\CustomFields\Controllers\Create
footer: false
---
...
* Full name: `\Leantime\Plugins\CustomFields\Controllers\Create`
...
```php
public Create::init(\Leantime\Plugins\CustomFields\Services\CustomFields $customFieldsService, \Leantime\Core\Environment $config): void
```
...
```php
public Create::get(array $params): \Symfony\Component\HttpFoundation\Response
```
