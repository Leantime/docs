---
title: \Leantime\Plugins\CustomFields\Hxcontrollers\Populate
footer: false
---
...
* Full name: `\Leantime\Plugins\CustomFields\Hxcontrollers\Populate`
...
```php
public Populate::init(\Leantime\Plugins\CustomFields\Services\CustomFields $customFieldsService, \Leantime\Core\Environment $config, \Leantime\Domain\Tickets\Services\Tickets $ticketsService): void
```
