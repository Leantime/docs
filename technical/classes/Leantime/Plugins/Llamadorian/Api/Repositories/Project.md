---
title: \Leantime\Plugins\Llamadorian\Api\Repositories\Project
footer: false
---

# Project

Repository for retrieving Project information for the AI API.



* Full name: `\Leantime\Plugins\Llamadorian\Api\Repositories\Project`
...
```php
public Project::getProjectDetailByUserId(int $userId, int $projectId): mixed
```
...
```php
public Project::getProjectDetail(int $projectId): mixed
```
