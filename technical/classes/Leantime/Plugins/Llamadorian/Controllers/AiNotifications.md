---
title: \Leantime\Plugins\Llamadorian\Controllers\AiNotifications
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\AiNotifications`
...
```php
public AiNotifications::init(\Leantime\Domain\Notifications\Services\Notifications $notificationsSvc): mixed
```
...
```php
public AiNotifications::post(mixed $params): void
```
