---
title: \Leantime\Plugins\Llamadorian\Controllers\AiSettings
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\AiSettings`
...
```php
public AiSettings::init(\Leantime\Plugins\Llamadorian\Services\StoryTime $storyTimeService): mixed
```
...
```php
public AiSettings::post(mixed $params): mixed
```
