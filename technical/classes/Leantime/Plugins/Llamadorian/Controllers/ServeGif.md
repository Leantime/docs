---
title: \Leantime\Plugins\Llamadorian\Controllers\ServeGif
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\ServeGif`
...
```php
public ServeGif::get(mixed $params): void
```
