---
title: \Leantime\Plugins\Llamadorian\Controllers\ShowStatusUpdate
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\ShowStatusUpdate`
...
```php
public ShowStatusUpdate::init(\Leantime\Plugins\Llamadorian\Services\StatusTracker $statusTrackerService): mixed
```
...
```php
public ShowStatusUpdate::get(mixed $params): void
```
