---
title: \Leantime\Plugins\Llamadorian\Controllers\StatusUpdates
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\StatusUpdates`
...
```php
public StatusUpdates::init(\Leantime\Plugins\Llamadorian\Services\StatusTracker $statusTrackerService, \Leantime\Domain\Setting\Services\Setting $settingsSvc): mixed
```
