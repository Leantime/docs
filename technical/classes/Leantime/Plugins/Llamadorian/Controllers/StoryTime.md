---
title: \Leantime\Plugins\Llamadorian\Controllers\StoryTime
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\StoryTime`
...
```php
public StoryTime::init(\Leantime\Plugins\Llamadorian\Services\StoryTime $storyTimeService): mixed
```
...
```php
public StoryTime::get(mixed $params): void
```
