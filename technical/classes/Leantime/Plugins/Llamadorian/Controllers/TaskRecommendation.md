---
title: \Leantime\Plugins\Llamadorian\Controllers\TaskRecommendation
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\TaskRecommendation`
...
```php
public TaskRecommendation::init(\Leantime\Plugins\Llamadorian\Services\TaskRecommendation $taskRecommendationService, \Leantime\Plugins\Llamadorian\Services\UserSentiment $userSentimentService): mixed
```
...
```php
public TaskRecommendation::post(): void
```
