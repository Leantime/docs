---
title: \Leantime\Plugins\Llamadorian\Controllers\TaskRecommendationTutorial
footer: false
---

# TaskRecommendationTutorial

Controller Class - Base class For all controllers



* Full name: `\Leantime\Plugins\Llamadorian\Controllers\TaskRecommendationTutorial`
...
```php
public TaskRecommendationTutorial::get(mixed $params): void
```
