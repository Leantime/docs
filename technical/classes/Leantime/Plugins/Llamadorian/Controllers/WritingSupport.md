---
title: \Leantime\Plugins\Llamadorian\Controllers\WritingSupport
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Controllers\WritingSupport`
...
```php
public WritingSupport::init(\Leantime\Plugins\Llamadorian\Services\StatusTracker $statusTrackerService): mixed
```
...
```php
public WritingSupport::post(): void
```
