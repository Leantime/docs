---
title: \Leantime\Plugins\Llamadorian\Hxcontrollers\SubtaskBreakdown
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Hxcontrollers\SubtaskBreakdown`
...
```php
public SubtaskBreakdown::init(\Leantime\Domain\Tickets\Services\Tickets $ticketsService, \Leantime\Plugins\Llamadorian\Services\TaskRecommendation $taskRecommendationService, \Leantime\Plugins\Llamadorian\Services\UserSentiment $userSentimentService): void
```
...
```php
public SubtaskBreakdown::get(): void
```
