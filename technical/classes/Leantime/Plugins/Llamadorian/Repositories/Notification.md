---
title: \Leantime\Plugins\Llamadorian\Repositories\Notification
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Repositories\Notification`
...
```php
public Notification::getAINotifications(mixed $userId): mixed
```
