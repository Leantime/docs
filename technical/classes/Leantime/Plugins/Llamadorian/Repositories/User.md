---
title: \Leantime\Plugins\Llamadorian\Repositories\User
footer: false
---
...
* Full name: `\Leantime\Plugins\Llamadorian\Repositories\User`
...
```php
public User::getUserIdsByProjectId(mixed $projectId): mixed
```
...
```php
public User::getUsersAssignedToProject(mixed $id): array|bool
```
