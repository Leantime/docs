---
title: \Leantime\Plugins\MotivationalQuotes\Controllers\Settings
footer: false
---
...
* Full name: `\Leantime\Plugins\MotivationalQuotes\Controllers\Settings`
...
```php
public Settings::post(array $params): void
```
