---
title: \Leantime\Plugins\Notes\Controllers\DelNote
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\DelNote`
...
```php
public DelNote::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
