---
title: \Leantime\Plugins\Notes\Controllers\DelNotebook
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\DelNotebook`
...
```php
public DelNotebook::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
