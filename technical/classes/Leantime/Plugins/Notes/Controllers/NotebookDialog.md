---
title: \Leantime\Plugins\Notes\Controllers\NotebookDialog
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\NotebookDialog`
...
```php
public NotebookDialog::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
...
```php
public NotebookDialog::get(mixed $params): mixed
```
...
```php
public NotebookDialog::post(mixed $params): mixed
```
...
```php
public NotebookDialog::put(mixed $params): mixed
```
...
```php
public NotebookDialog::delete(mixed $params): mixed
```
