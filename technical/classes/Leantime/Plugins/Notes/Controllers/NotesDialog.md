---
title: \Leantime\Plugins\Notes\Controllers\NotesDialog
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\NotesDialog`
...
```php
public NotesDialog::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
...
```php
public NotesDialog::get(mixed $params): mixed
```
...
```php
public NotesDialog::post(mixed $params): mixed
```
...
```php
public NotesDialog::put(mixed $params): mixed
```
...
```php
public NotesDialog::delete(mixed $params): mixed
```
