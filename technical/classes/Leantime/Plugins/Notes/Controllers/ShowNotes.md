---
title: \Leantime\Plugins\Notes\Controllers\ShowNotes
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\ShowNotes`
...
```php
public ShowNotes::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
