---
title: \Leantime\Plugins\Notes\Controllers\ShowNotesList
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Controllers\ShowNotesList`
...
```php
public ShowNotesList::init(\Leantime\Plugins\Notes\Services\Notes $notesService): mixed
```
...
```php
public ShowNotesList::run(): mixed
```
