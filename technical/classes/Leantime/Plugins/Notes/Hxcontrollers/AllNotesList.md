---
title: \Leantime\Plugins\Notes\Hxcontrollers\AllNotesList
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Hxcontrollers\AllNotesList`
...
```php
public AllNotesList::init(\Leantime\Plugins\Notes\Services\Notes $notesService): void
```
