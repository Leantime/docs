---
title: \Leantime\Plugins\Notes\Hxcontrollers\SingleNote
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Hxcontrollers\SingleNote`
...
```php
public SingleNote::init(\Leantime\Plugins\Notes\Services\Notes $noteService): void
```
