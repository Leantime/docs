---
title: \Leantime\Plugins\Notes\Hxcontrollers\SingleNoteWidget
footer: false
---
...
* Full name: `\Leantime\Plugins\Notes\Hxcontrollers\SingleNoteWidget`
...
```php
public SingleNoteWidget::init(\Leantime\Plugins\Notes\Services\Notes $noteService): void
```
...
|-----------|------|-------------|
| `noteService` | **\Leantime\Plugins\Notes\Services\Notes** |  |
...
```php
public SingleNoteWidget::save(): void
```
...
```php
public SingleNoteWidget::get(): void
```
...
```php
public SingleNoteWidget::new(): void
```
