---
title: \Leantime\Plugins\PgmPro\Controllers\DelProgram
footer: false
---
...
* Full name: `\Leantime\Plugins\PgmPro\Controllers\DelProgram`
...
```php
public DelProgram::init(\Leantime\Domain\Projects\Repositories\Projects $projectRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
