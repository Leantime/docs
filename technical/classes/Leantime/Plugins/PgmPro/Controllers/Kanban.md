---
title: \Leantime\Plugins\PgmPro\Controllers\Kanban
footer: false
---
...
* Full name: `\Leantime\Plugins\PgmPro\Controllers\Kanban`
...
```php
public Kanban::init(\Leantime\Plugins\PgmPro\Services\Programs $programService): mixed
```
