---
title: \Leantime\Plugins\StrategyPro\Controllers\DelStrategy
footer: false
---
...
* Full name: `\Leantime\Plugins\StrategyPro\Controllers\DelStrategy`
...
```php
public DelStrategy::init(\Leantime\Domain\Projects\Repositories\Projects $projectRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
