---
title: \Leantime\Plugins\StrategyPro\Controllers\EditCanvasItem
footer: false
---
...
* Full name: `\Leantime\Plugins\StrategyPro\Controllers\EditCanvasItem`
...
```php
public EditCanvasItem::init(\Leantime\Domain\Goalcanvas\Repositories\Goalcanvas $canvasRepo, \Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Domain\Comments\Repositories\Comments $commentsRepo, \Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Domain\Goalcanvas\Services\Goalcanvas $goalService): mixed
```
