---
title: \Leantime\Plugins\StrategyPro\Controllers\ShowStrategyOnboarding
footer: false
---
...
* Full name: `\Leantime\Plugins\StrategyPro\Controllers\ShowStrategyOnboarding`
...
```php
public ShowStrategyOnboarding::get(mixed $params): mixed
```
...
```php
public ShowStrategyOnboarding::post(mixed $params): mixed
```
...
```php
public ShowStrategyOnboarding::put(mixed $params): mixed
```
...
```php
public ShowStrategyOnboarding::delete(mixed $params): mixed
```
