---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\Api
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\Api`
...
```php
public Api::init(\Leantime\Plugins\Whiteboardscanvas\Repositories\Whiteboardscanvas $whiteboardAPIRepo): mixed
```
...
```php
public Api::get(mixed $params): mixed
```
...
```php
public Api::post(mixed $params): mixed
```
...
```php
public Api::patch(mixed $params): mixed
```
...
```php
public Api::delete(mixed $params): mixed
```
