---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\Dashboard
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\Dashboard`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Plugins\Whiteboardscanvas\Controllers\Dashboard::CANVAS_NAME`||&#039;Whiteboards&#039;|
...
```php
public Dashboard::init(\Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Plugins\Whiteboardscanvas\Services\Whiteboardscanvas $whiteboardService, \Leantime\Plugins\Whiteboardscanvas\Repositories\Whiteboardscanvas $whiteboardRepo): mixed
```
