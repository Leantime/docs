---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\DelCanvasItem
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\DelCanvasItem`
...
```php
public DelCanvasItem::init(\Leantime\Plugins\Whiteboardscanvas\Repositories\Whiteboardscanvas $whiteboardAPIRepo): mixed
```
