---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\Settings
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\Settings`
...
```php
public Settings::post(mixed $params): mixed
```
