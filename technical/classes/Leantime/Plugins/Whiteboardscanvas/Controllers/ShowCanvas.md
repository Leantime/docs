---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\ShowCanvas
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\ShowCanvas`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Plugins\Whiteboardscanvas\Controllers\ShowCanvas::CANVAS_NAME`||&#039;whiteboards&#039;|
...
```php
public ShowCanvas::init(\Leantime\Plugins\Whiteboardscanvas\Repositories\Whiteboardscanvas $whiteboardAPIRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
