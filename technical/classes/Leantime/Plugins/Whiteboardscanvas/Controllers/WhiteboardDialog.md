---
title: \Leantime\Plugins\Whiteboardscanvas\Controllers\WhiteboardDialog
footer: false
---
...
* Full name: `\Leantime\Plugins\Whiteboardscanvas\Controllers\WhiteboardDialog`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Leantime\Plugins\Whiteboardscanvas\Controllers\WhiteboardDialog::CANVAS_NAME`||&#039;whiteboards&#039;|
...
```php
public WhiteboardDialog::init(\Leantime\Plugins\Whiteboardscanvas\Repositories\Whiteboardscanvas $whiteboardAPIRepo, \Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Domain\Comments\Repositories\Comments $commentsRepo, \Leantime\Domain\Projects\Services\Projects $projectService, \Leantime\Plugins\Whiteboardscanvas\Services\Whiteboardscanvas $whiteboardService): mixed
```
...
```php
public WhiteboardDialog::get(mixed $params): mixed
```
...
```php
public WhiteboardDialog::post(mixed $params): mixed
```
...
```php
public WhiteboardDialog::put(mixed $params): mixed
```
...
```php
public WhiteboardDialog::delete(mixed $params): mixed
```
