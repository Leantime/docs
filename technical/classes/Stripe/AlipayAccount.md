...
* Full name: `\Stripe\AlipayAccount`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\AlipayAccount::OBJECT_NAME`||&#039;alipay_account&#039;|
...
```php
public AlipayAccount::instanceUrl(): string
```
...
```php
public static AlipayAccount::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static AlipayAccount::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
