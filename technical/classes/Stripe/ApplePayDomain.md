...
* Full name: `\Stripe\ApplePayDomain`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\ApplePayDomain::OBJECT_NAME`||&#039;apple_pay_domain&#039;|
...
```php
public static ApplePayDomain::classUrl(): string
```
