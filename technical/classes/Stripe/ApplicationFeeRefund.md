---
title: \Stripe\ApplicationFeeRefund
footer: false
---
...
* Full name: `\Stripe\ApplicationFeeRefund`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\ApplicationFeeRefund::OBJECT_NAME`||&#039;fee_refund&#039;|
...
```php
public ApplicationFeeRefund::instanceUrl(): string
```
...
the API URL for this Stripe refund
...
```php
public ApplicationFeeRefund::save(null|array|string $opts = null): \Stripe\ApplicationFeeRefund
```
