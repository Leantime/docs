...
* Full name: `\Stripe\Balance`
* Parent class: [\Stripe\SingletonApiResource](technical/SingletonApiResource.md)
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Balance::OBJECT_NAME`||&#039;balance&#039;|
...
```php
public static Balance::retrieve(null|array|string $opts = null): \Stripe\Balance
```
