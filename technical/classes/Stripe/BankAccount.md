...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\BankAccount::OBJECT_NAME`||&#039;bank_account&#039;|
|`\Stripe\BankAccount::STATUS_NEW`||&#039;new&#039;|
|`\Stripe\BankAccount::STATUS_VALIDATED`||&#039;validated&#039;|
|`\Stripe\BankAccount::STATUS_VERIFIED`||&#039;verified&#039;|
|`\Stripe\BankAccount::STATUS_VERIFICATION_FAILED`||&#039;verification_failed&#039;|
|`\Stripe\BankAccount::STATUS_ERRORED`||&#039;errored&#039;|
...
```php
public BankAccount::instanceUrl(): string
```
...
The instance URL for this resource. It needs to be special
...
```php
public static BankAccount::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static BankAccount::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
...
```php
public BankAccount::verify(null|array $params = null, null|array|string $opts = null): \Stripe\BankAccount
```
