...
* Full name: `\Stripe\BitcoinReceiver`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\BitcoinReceiver::OBJECT_NAME`||&#039;bitcoin_receiver&#039;|
...
```php
public static BitcoinReceiver::classUrl(): string
```
...
The class URL for this resource. It needs to be special
...
```php
public BitcoinReceiver::instanceUrl(): string
```
