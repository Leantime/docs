...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Capability::OBJECT_NAME`||&#039;capability&#039;|
|`\Stripe\Capability::STATUS_ACTIVE`||&#039;active&#039;|
|`\Stripe\Capability::STATUS_INACTIVE`||&#039;inactive&#039;|
|`\Stripe\Capability::STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Capability::STATUS_UNREQUESTED`||&#039;unrequested&#039;|
...
```php
public Capability::instanceUrl(): string
```
...
```php
public static Capability::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static Capability::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
