...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Card::OBJECT_NAME`||&#039;card&#039;|
|`\Stripe\Card::CVC_CHECK_FAIL`||&#039;fail&#039;|
|`\Stripe\Card::CVC_CHECK_PASS`||&#039;pass&#039;|
|`\Stripe\Card::CVC_CHECK_UNAVAILABLE`||&#039;unavailable&#039;|
|`\Stripe\Card::CVC_CHECK_UNCHECKED`||&#039;unchecked&#039;|
|`\Stripe\Card::FUNDING_CREDIT`||&#039;credit&#039;|
|`\Stripe\Card::FUNDING_DEBIT`||&#039;debit&#039;|
|`\Stripe\Card::FUNDING_PREPAID`||&#039;prepaid&#039;|
|`\Stripe\Card::FUNDING_UNKNOWN`||&#039;unknown&#039;|
|`\Stripe\Card::TOKENIZATION_METHOD_APPLE_PAY`||&#039;apple_pay&#039;|
|`\Stripe\Card::TOKENIZATION_METHOD_GOOGLE_PAY`||&#039;google_pay&#039;|
...
```php
public Card::instanceUrl(): string
```
...
```php
public static Card::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static Card::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
