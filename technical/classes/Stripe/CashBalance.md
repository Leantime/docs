...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\CashBalance::OBJECT_NAME`||&#039;cash_balance&#039;|
...
```php
public CashBalance::instanceUrl(): string
```
...
```php
public static CashBalance::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static CashBalance::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
