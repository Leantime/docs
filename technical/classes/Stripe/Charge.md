...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Charge::OBJECT_NAME`||&#039;charge&#039;|
|`\Stripe\Charge::STATUS_FAILED`||&#039;failed&#039;|
|`\Stripe\Charge::STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Charge::STATUS_SUCCEEDED`||&#039;succeeded&#039;|
|`\Stripe\Charge::DECLINED_AUTHENTICATION_REQUIRED`||&#039;authentication_required&#039;|
|`\Stripe\Charge::DECLINED_APPROVE_WITH_ID`||&#039;approve_with_id&#039;|
|`\Stripe\Charge::DECLINED_CALL_ISSUER`||&#039;call_issuer&#039;|
|`\Stripe\Charge::DECLINED_CARD_NOT_SUPPORTED`||&#039;card_not_supported&#039;|
|`\Stripe\Charge::DECLINED_CARD_VELOCITY_EXCEEDED`||&#039;card_velocity_exceeded&#039;|
|`\Stripe\Charge::DECLINED_CURRENCY_NOT_SUPPORTED`||&#039;currency_not_supported&#039;|
|`\Stripe\Charge::DECLINED_DO_NOT_HONOR`||&#039;do_not_honor&#039;|
|`\Stripe\Charge::DECLINED_DO_NOT_TRY_AGAIN`||&#039;do_not_try_again&#039;|
|`\Stripe\Charge::DECLINED_DUPLICATED_TRANSACTION`||&#039;duplicate_transaction&#039;|
|`\Stripe\Charge::DECLINED_EXPIRED_CARD`||&#039;expired_card&#039;|
|`\Stripe\Charge::DECLINED_FRAUDULENT`||&#039;fraudulent&#039;|
|`\Stripe\Charge::DECLINED_GENERIC_DECLINE`||&#039;generic_decline&#039;|
|`\Stripe\Charge::DECLINED_INCORRECT_NUMBER`||&#039;incorrect_number&#039;|
|`\Stripe\Charge::DECLINED_INCORRECT_CVC`||&#039;incorrect_cvc&#039;|
|`\Stripe\Charge::DECLINED_INCORRECT_PIN`||&#039;incorrect_pin&#039;|
|`\Stripe\Charge::DECLINED_INCORRECT_ZIP`||&#039;incorrect_zip&#039;|
|`\Stripe\Charge::DECLINED_INSUFFICIENT_FUNDS`||&#039;insufficient_funds&#039;|
|`\Stripe\Charge::DECLINED_INVALID_ACCOUNT`||&#039;invalid_account&#039;|
|`\Stripe\Charge::DECLINED_INVALID_AMOUNT`||&#039;invalid_amount&#039;|
|`\Stripe\Charge::DECLINED_INVALID_CVC`||&#039;invalid_cvc&#039;|
|`\Stripe\Charge::DECLINED_INVALID_EXPIRY_YEAR`||&#039;invalid_expiry_year&#039;|
|`\Stripe\Charge::DECLINED_INVALID_NUMBER`||&#039;invalid_number&#039;|
|`\Stripe\Charge::DECLINED_INVALID_PIN`||&#039;invalid_pin&#039;|
|`\Stripe\Charge::DECLINED_ISSUER_NOT_AVAILABLE`||&#039;issuer_not_available&#039;|
|`\Stripe\Charge::DECLINED_LOST_CARD`||&#039;lost_card&#039;|
|`\Stripe\Charge::DECLINED_MERCHANT_BLACKLIST`||&#039;merchant_blacklist&#039;|
|`\Stripe\Charge::DECLINED_NEW_ACCOUNT_INFORMATION_AVAILABLE`||&#039;new_account_information_available&#039;|
|`\Stripe\Charge::DECLINED_NO_ACTION_TAKEN`||&#039;no_action_taken&#039;|
|`\Stripe\Charge::DECLINED_NOT_PERMITTED`||&#039;not_permitted&#039;|
|`\Stripe\Charge::DECLINED_OFFLINE_PIN_REQUIRED`||&#039;offline_pin_required&#039;|
|`\Stripe\Charge::DECLINED_ONLINE_OR_OFFLINE_PIN_REQUIRED`||&#039;online_or_offline_pin_required&#039;|
|`\Stripe\Charge::DECLINED_PICKUP_CARD`||&#039;pickup_card&#039;|
|`\Stripe\Charge::DECLINED_PIN_TRY_EXCEEDED`||&#039;pin_try_exceeded&#039;|
|`\Stripe\Charge::DECLINED_PROCESSING_ERROR`||&#039;processing_error&#039;|
|`\Stripe\Charge::DECLINED_REENTER_TRANSACTION`||&#039;reenter_transaction&#039;|
|`\Stripe\Charge::DECLINED_RESTRICTED_CARD`||&#039;restricted_card&#039;|
|`\Stripe\Charge::DECLINED_REVOCATION_OF_ALL_AUTHORIZATIONS`||&#039;revocation_of_all_authorizations&#039;|
|`\Stripe\Charge::DECLINED_REVOCATION_OF_AUTHORIZATION`||&#039;revocation_of_authorization&#039;|
|`\Stripe\Charge::DECLINED_SECURITY_VIOLATION`||&#039;security_violation&#039;|
|`\Stripe\Charge::DECLINED_SERVICE_NOT_ALLOWED`||&#039;service_not_allowed&#039;|
|`\Stripe\Charge::DECLINED_STOLEN_CARD`||&#039;stolen_card&#039;|
|`\Stripe\Charge::DECLINED_STOP_PAYMENT_ORDER`||&#039;stop_payment_order&#039;|
|`\Stripe\Charge::DECLINED_TESTMODE_DECLINE`||&#039;testmode_decline&#039;|
|`\Stripe\Charge::DECLINED_TRANSACTION_NOT_ALLOWED`||&#039;transaction_not_allowed&#039;|
|`\Stripe\Charge::DECLINED_TRY_AGAIN_LATER`||&#039;try_again_later&#039;|
|`\Stripe\Charge::DECLINED_WITHDRAWAL_COUNT_LIMIT_EXCEEDED`||&#039;withdrawal_count_limit_exceeded&#039;|
...
```php
public Charge::capture(null|array $params = null, null|array|string $opts = null): \Stripe\Charge
```
...
```php
public static Charge::search(null|array $params = null, null|array|string $opts = null): \Stripe\SearchResult&lt;\Stripe\Charge&gt;
```
