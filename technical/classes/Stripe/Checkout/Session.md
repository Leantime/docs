...
* Full name: `\Stripe\Checkout\Session`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Checkout\Session::OBJECT_NAME`||&#039;checkout.session&#039;|
|`\Stripe\Checkout\Session::BILLING_ADDRESS_COLLECTION_AUTO`||&#039;auto&#039;|
|`\Stripe\Checkout\Session::BILLING_ADDRESS_COLLECTION_REQUIRED`||&#039;required&#039;|
|`\Stripe\Checkout\Session::CUSTOMER_CREATION_ALWAYS`||&#039;always&#039;|
|`\Stripe\Checkout\Session::CUSTOMER_CREATION_IF_REQUIRED`||&#039;if_required&#039;|
|`\Stripe\Checkout\Session::MODE_PAYMENT`||&#039;payment&#039;|
|`\Stripe\Checkout\Session::MODE_SETUP`||&#039;setup&#039;|
|`\Stripe\Checkout\Session::MODE_SUBSCRIPTION`||&#039;subscription&#039;|
|`\Stripe\Checkout\Session::PAYMENT_STATUS_NO_PAYMENT_REQUIRED`||&#039;no_payment_required&#039;|
|`\Stripe\Checkout\Session::PAYMENT_STATUS_PAID`||&#039;paid&#039;|
|`\Stripe\Checkout\Session::PAYMENT_STATUS_UNPAID`||&#039;unpaid&#039;|
|`\Stripe\Checkout\Session::STATUS_COMPLETE`||&#039;complete&#039;|
|`\Stripe\Checkout\Session::STATUS_EXPIRED`||&#039;expired&#039;|
|`\Stripe\Checkout\Session::STATUS_OPEN`||&#039;open&#039;|
|`\Stripe\Checkout\Session::SUBMIT_TYPE_AUTO`||&#039;auto&#039;|
|`\Stripe\Checkout\Session::SUBMIT_TYPE_BOOK`||&#039;book&#039;|
|`\Stripe\Checkout\Session::SUBMIT_TYPE_DONATE`||&#039;donate&#039;|
|`\Stripe\Checkout\Session::SUBMIT_TYPE_PAY`||&#039;pay&#039;|
|`\Stripe\Checkout\Session::PATH_LINE_ITEMS`||&#039;/line_items&#039;|
...
```php
public Session::expire(null|array $params = null, null|array|string $opts = null): \Stripe\Checkout\Session
```
...
```php
public static Session::allLineItems(string $id, null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\LineItem&gt;
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `id` | **string** | the ID of the session on which to retrieve the items |
| `params` | **null|array** |  |
| `opts` | **null|array|string** |  |
