...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Collection::OBJECT_NAME`||&#039;list&#039;|
...
```php
public static Collection::baseUrl(): string
```
...
```php
public Collection::getFilters(): array
```
...
```php
public Collection::setFilters(array $filters): mixed
```
...
```php
public Collection::offsetGet(mixed $k): mixed
```
...
```php
public Collection::all(null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\TStripeObject&gt;
```
...
```php
public Collection::create(null|array $params = null, null|array|string $opts = null): \Stripe\TStripeObject
```
...
```php
public Collection::retrieve(string $id, null|array $params = null, null|array|string $opts = null): \Stripe\TStripeObject
```
...
```php
public Collection::getIterator(): \ArrayIterator
```
...
```php
public Collection::getReverseIterator(): \ArrayIterator
```
...
```php
public Collection::autoPagingIterator(): \Generator|\Stripe\TStripeObject[]
```
...
```php
public static Collection::emptyCollection(null|array|string $opts = null): \Stripe\Collection
```
...
```php
public Collection::isEmpty(): bool
```
...
```php
public Collection::nextPage(null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\TStripeObject&gt;
```
...
```php
public Collection::previousPage(null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\TStripeObject&gt;
```
...
```php
public Collection::first(): null|\Stripe\TStripeObject
```
...
```php
public Collection::last(): null|\Stripe\TStripeObject
```
...
```php
private Collection::extractPathAndUpdateParams(mixed $params): mixed
```
