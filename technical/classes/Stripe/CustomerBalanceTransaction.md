---
title: \Stripe\CustomerBalanceTransaction
footer: false
---
...
* Full name: `\Stripe\CustomerBalanceTransaction`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\CustomerBalanceTransaction::OBJECT_NAME`||&#039;customer_balance_transaction&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_ADJUSTMENT`||&#039;adjustment&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_APPLIED_TO_INVOICE`||&#039;applied_to_invoice&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_CREDIT_NOTE`||&#039;credit_note&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_INITIAL`||&#039;initial&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_INVOICE_TOO_LARGE`||&#039;invoice_too_large&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_INVOICE_TOO_SMALL`||&#039;invoice_too_small&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_UNSPENT_RECEIVER_CREDIT`||&#039;unspent_receiver_credit&#039;|
|`\Stripe\CustomerBalanceTransaction::TYPE_ADJUSTEMENT`||&#039;adjustment&#039;|
...
```php
public CustomerBalanceTransaction::instanceUrl(): string
```
...
the API URL for this balance transaction
...
```php
public static CustomerBalanceTransaction::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static CustomerBalanceTransaction::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
