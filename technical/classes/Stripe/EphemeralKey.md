...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\EphemeralKey::OBJECT_NAME`||&#039;ephemeral_key&#039;|
...
```php
public static EphemeralKey::create(null|array $params = null, null|array|string $opts = null): \Stripe\EphemeralKey
```
