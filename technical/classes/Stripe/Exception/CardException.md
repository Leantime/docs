---
title: \Stripe\Exception\CardException
footer: false
---
...
* Full name: `\Stripe\Exception\CardException`
...
```php
public static CardException::factory(string $message, null|int $httpStatus = null, null|string $httpBody = null, null|array $jsonBody = null, null|array|\Stripe\Util\CaseInsensitiveArray $httpHeaders = null, null|string $stripeCode = null, null|string $declineCode = null, null|string $stripeParam = null): \Stripe\Exception\CardException
```
...
| `declineCode` | **null|string** | the decline code |
| `stripeParam` | **null|string** | the parameter related to the error |
...
```php
public CardException::getDeclineCode(): null|string
```
...
```php
public CardException::setDeclineCode(null|string $declineCode): mixed
```
...
```php
public CardException::getStripeParam(): null|string
```
...
```php
public CardException::setStripeParam(null|string $stripeParam): mixed
```
