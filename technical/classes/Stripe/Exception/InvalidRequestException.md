---
title: \Stripe\Exception\InvalidRequestException
footer: false
---
...
* Full name: `\Stripe\Exception\InvalidRequestException`
...
```php
public static InvalidRequestException::factory(string $message, null|int $httpStatus = null, null|string $httpBody = null, null|array $jsonBody = null, null|array|\Stripe\Util\CaseInsensitiveArray $httpHeaders = null, null|string $stripeCode = null, null|string $stripeParam = null): \Stripe\Exception\InvalidRequestException
```
...
```php
public InvalidRequestException::getStripeParam(): null|string
```
...
```php
public InvalidRequestException::setStripeParam(null|string $stripeParam): mixed
```
