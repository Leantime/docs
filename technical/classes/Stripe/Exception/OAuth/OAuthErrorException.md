---
title: \Stripe\Exception\OAuth\OAuthErrorException
footer: false
---
...
* Full name: `\Stripe\Exception\OAuth\OAuthErrorException`
* Parent class: [\Stripe\Exception\ApiErrorException](../ApiErrorException.md)
...
```php
protected OAuthErrorException::constructErrorObject(): mixed
```
