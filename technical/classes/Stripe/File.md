...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\File::OBJECT_NAME`||&#039;file&#039;|
|`\Stripe\File::PURPOSE_ACCOUNT_REQUIREMENT`||&#039;account_requirement&#039;|
|`\Stripe\File::PURPOSE_ADDITIONAL_VERIFICATION`||&#039;additional_verification&#039;|
|`\Stripe\File::PURPOSE_BUSINESS_ICON`||&#039;business_icon&#039;|
|`\Stripe\File::PURPOSE_BUSINESS_LOGO`||&#039;business_logo&#039;|
|`\Stripe\File::PURPOSE_CUSTOMER_SIGNATURE`||&#039;customer_signature&#039;|
|`\Stripe\File::PURPOSE_DISPUTE_EVIDENCE`||&#039;dispute_evidence&#039;|
|`\Stripe\File::PURPOSE_DOCUMENT_PROVIDER_IDENTITY_DOCUMENT`||&#039;document_provider_identity_document&#039;|
|`\Stripe\File::PURPOSE_FINANCE_REPORT_RUN`||&#039;finance_report_run&#039;|
|`\Stripe\File::PURPOSE_IDENTITY_DOCUMENT`||&#039;identity_document&#039;|
|`\Stripe\File::PURPOSE_IDENTITY_DOCUMENT_DOWNLOADABLE`||&#039;identity_document_downloadable&#039;|
|`\Stripe\File::PURPOSE_PCI_DOCUMENT`||&#039;pci_document&#039;|
|`\Stripe\File::PURPOSE_SELFIE`||&#039;selfie&#039;|
|`\Stripe\File::PURPOSE_SIGMA_SCHEDULED_QUERY`||&#039;sigma_scheduled_query&#039;|
|`\Stripe\File::PURPOSE_TAX_DOCUMENT_USER_UPLOAD`||&#039;tax_document_user_upload&#039;|
|`\Stripe\File::OBJECT_NAME_ALT`||&#039;file_upload&#039;|
...
```php
public static File::classUrl(): string
```
...
```php
public static File::create(null|array $params = null, null|array|string $opts = null): \Stripe\File
```
