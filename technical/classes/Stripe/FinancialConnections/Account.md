---
title: \Stripe\FinancialConnections\Account
footer: false
---
...
* Full name: `\Stripe\FinancialConnections\Account`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\FinancialConnections\Account::OBJECT_NAME`||&#039;financial_connections.account&#039;|
|`\Stripe\FinancialConnections\Account::CATEGORY_CASH`||&#039;cash&#039;|
|`\Stripe\FinancialConnections\Account::CATEGORY_CREDIT`||&#039;credit&#039;|
|`\Stripe\FinancialConnections\Account::CATEGORY_INVESTMENT`||&#039;investment&#039;|
|`\Stripe\FinancialConnections\Account::CATEGORY_OTHER`||&#039;other&#039;|
|`\Stripe\FinancialConnections\Account::STATUS_ACTIVE`||&#039;active&#039;|
|`\Stripe\FinancialConnections\Account::STATUS_DISCONNECTED`||&#039;disconnected&#039;|
|`\Stripe\FinancialConnections\Account::STATUS_INACTIVE`||&#039;inactive&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_CHECKING`||&#039;checking&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_CREDIT_CARD`||&#039;credit_card&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_LINE_OF_CREDIT`||&#039;line_of_credit&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_MORTGAGE`||&#039;mortgage&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_OTHER`||&#039;other&#039;|
|`\Stripe\FinancialConnections\Account::SUBCATEGORY_SAVINGS`||&#039;savings&#039;|
...
```php
public Account::disconnect(null|array $params = null, null|array|string $opts = null): \Stripe\FinancialConnections\Account
```
...
```php
public Account::refresh(null|array $params = null, null|array|string $opts = null): \Stripe\FinancialConnections\Account
```
