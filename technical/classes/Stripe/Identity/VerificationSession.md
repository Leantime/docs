---
title: \Stripe\Identity\VerificationSession
footer: false
---
...
* Full name: `\Stripe\Identity\VerificationSession`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Identity\VerificationSession::OBJECT_NAME`||&#039;identity.verification_session&#039;|
|`\Stripe\Identity\VerificationSession::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Identity\VerificationSession::STATUS_PROCESSING`||&#039;processing&#039;|
|`\Stripe\Identity\VerificationSession::STATUS_REQUIRES_INPUT`||&#039;requires_input&#039;|
|`\Stripe\Identity\VerificationSession::STATUS_VERIFIED`||&#039;verified&#039;|
|`\Stripe\Identity\VerificationSession::TYPE_DOCUMENT`||&#039;document&#039;|
|`\Stripe\Identity\VerificationSession::TYPE_ID_NUMBER`||&#039;id_number&#039;|
...
```php
public VerificationSession::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\Identity\VerificationSession
```
...
the canceled verification session
...
```php
public VerificationSession::redact(null|array $params = null, null|array|string $opts = null): \Stripe\Identity\VerificationSession
```
...
the redacted verification session
