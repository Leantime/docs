...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Issuing\Card::OBJECT_NAME`||&#039;issuing.card&#039;|
...
```php
public Card::details(null|array $params = null, null|array|string $opts = null): \Stripe\Issuing\CardDetails
```
...
the card details associated with that issuing card
