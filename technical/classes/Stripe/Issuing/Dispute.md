...
* Full name: `\Stripe\Issuing\Dispute`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Issuing\Dispute::OBJECT_NAME`||&#039;issuing.dispute&#039;|
...
```php
public Dispute::submit(null|array $params = null, null|array|string $opts = null): \Stripe\Issuing\Dispute
```
