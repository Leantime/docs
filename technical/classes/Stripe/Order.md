...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Order::OBJECT_NAME`||&#039;order&#039;|
...
```php
public Order::returnOrder(null|array $params = null, null|array|string $opts = null): \Stripe\OrderReturn
```
...
```php
public Order::pay(null|array $params = null, null|array|string $opts = null): \Stripe\Order
```
