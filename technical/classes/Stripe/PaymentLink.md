...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\PaymentLink::OBJECT_NAME`||&#039;payment_link&#039;|
|`\Stripe\PaymentLink::BILLING_ADDRESS_COLLECTION_AUTO`||&#039;auto&#039;|
|`\Stripe\PaymentLink::BILLING_ADDRESS_COLLECTION_REQUIRED`||&#039;required&#039;|
...
```php
public static PaymentLink::allLineItems(mixed $id, null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\PaymentLink&gt;
```
