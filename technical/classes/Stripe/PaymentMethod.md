...
* Full name: `\Stripe\PaymentMethod`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\PaymentMethod::OBJECT_NAME`||&#039;payment_method&#039;|
...
```php
public PaymentMethod::attach(null|array $params = null, null|array|string $opts = null): \Stripe\PaymentMethod
```
...
```php
public PaymentMethod::detach(null|array $params = null, null|array|string $opts = null): \Stripe\PaymentMethod
```
