...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Payout::OBJECT_NAME`||&#039;payout&#039;|
|`\Stripe\Payout::FAILURE_ACCOUNT_CLOSED`||&#039;account_closed&#039;|
|`\Stripe\Payout::FAILURE_ACCOUNT_FROZEN`||&#039;account_frozen&#039;|
|`\Stripe\Payout::FAILURE_BANK_ACCOUNT_RESTRICTED`||&#039;bank_account_restricted&#039;|
|`\Stripe\Payout::FAILURE_BANK_OWNERSHIP_CHANGED`||&#039;bank_ownership_changed&#039;|
|`\Stripe\Payout::FAILURE_COULD_NOT_PROCESS`||&#039;could_not_process&#039;|
|`\Stripe\Payout::FAILURE_DEBIT_NOT_AUTHORIZED`||&#039;debit_not_authorized&#039;|
|`\Stripe\Payout::FAILURE_DECLINED`||&#039;declined&#039;|
|`\Stripe\Payout::FAILURE_INCORRECT_ACCOUNT_HOLDER_NAME`||&#039;incorrect_account_holder_name&#039;|
|`\Stripe\Payout::FAILURE_INSUFFICIENT_FUNDS`||&#039;insufficient_funds&#039;|
|`\Stripe\Payout::FAILURE_INVALID_ACCOUNT_NUMBER`||&#039;invalid_account_number&#039;|
|`\Stripe\Payout::FAILURE_INVALID_CURRENCY`||&#039;invalid_currency&#039;|
|`\Stripe\Payout::FAILURE_NO_ACCOUNT`||&#039;no_account&#039;|
|`\Stripe\Payout::FAILURE_UNSUPPORTED_CARD`||&#039;unsupported_card&#039;|
|`\Stripe\Payout::METHOD_INSTANT`||&#039;instant&#039;|
|`\Stripe\Payout::METHOD_STANDARD`||&#039;standard&#039;|
|`\Stripe\Payout::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Payout::STATUS_FAILED`||&#039;failed&#039;|
|`\Stripe\Payout::STATUS_IN_TRANSIT`||&#039;in_transit&#039;|
|`\Stripe\Payout::STATUS_PAID`||&#039;paid&#039;|
|`\Stripe\Payout::STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Payout::TYPE_BANK_ACCOUNT`||&#039;bank_account&#039;|
|`\Stripe\Payout::TYPE_CARD`||&#039;card&#039;|
...
```php
public Payout::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\Payout
```
...
```php
public Payout::reverse(null|array $params = null, null|array|string $opts = null): \Stripe\Payout
```
