...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Person::OBJECT_NAME`||&#039;person&#039;|
|`\Stripe\Person::GENDER_FEMALE`||&#039;female&#039;|
|`\Stripe\Person::GENDER_MALE`||&#039;male&#039;|
|`\Stripe\Person::POLITICAL_EXPOSURE_EXISTING`||&#039;existing&#039;|
|`\Stripe\Person::POLITICAL_EXPOSURE_NONE`||&#039;none&#039;|
|`\Stripe\Person::VERIFICATION_STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Person::VERIFICATION_STATUS_UNVERIFIED`||&#039;unverified&#039;|
|`\Stripe\Person::VERIFICATION_STATUS_VERIFIED`||&#039;verified&#039;|
...
```php
public Person::instanceUrl(): string
```
...
the API URL for this Stripe account reversal
...
```php
public static Person::retrieve(array|string $_id, null|array|string $_opts = null): mixed
```
...
```php
public static Person::update(string $_id, null|array $_params = null, null|array|string $_options = null): mixed
```
