...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Price::OBJECT_NAME`||&#039;price&#039;|
|`\Stripe\Price::BILLING_SCHEME_PER_UNIT`||&#039;per_unit&#039;|
|`\Stripe\Price::BILLING_SCHEME_TIERED`||&#039;tiered&#039;|
|`\Stripe\Price::TAX_BEHAVIOR_EXCLUSIVE`||&#039;exclusive&#039;|
|`\Stripe\Price::TAX_BEHAVIOR_INCLUSIVE`||&#039;inclusive&#039;|
|`\Stripe\Price::TAX_BEHAVIOR_UNSPECIFIED`||&#039;unspecified&#039;|
|`\Stripe\Price::TIERS_MODE_GRADUATED`||&#039;graduated&#039;|
|`\Stripe\Price::TIERS_MODE_VOLUME`||&#039;volume&#039;|
|`\Stripe\Price::TYPE_ONE_TIME`||&#039;one_time&#039;|
|`\Stripe\Price::TYPE_RECURRING`||&#039;recurring&#039;|
...
```php
public static Price::search(null|array $params = null, null|array|string $opts = null): \Stripe\SearchResult&lt;\Stripe\Price&gt;
```
