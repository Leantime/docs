...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Product::OBJECT_NAME`||&#039;product&#039;|
|`\Stripe\Product::TYPE_GOOD`||&#039;good&#039;|
|`\Stripe\Product::TYPE_SERVICE`||&#039;service&#039;|
...
```php
public static Product::search(null|array $params = null, null|array|string $opts = null): \Stripe\SearchResult&lt;\Stripe\Product&gt;
```
