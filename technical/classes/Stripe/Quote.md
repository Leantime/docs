...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Quote::OBJECT_NAME`||&#039;quote&#039;|
|`\Stripe\Quote::COLLECTION_METHOD_CHARGE_AUTOMATICALLY`||&#039;charge_automatically&#039;|
|`\Stripe\Quote::COLLECTION_METHOD_SEND_INVOICE`||&#039;send_invoice&#039;|
|`\Stripe\Quote::STATUS_ACCEPTED`||&#039;accepted&#039;|
|`\Stripe\Quote::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Quote::STATUS_DRAFT`||&#039;draft&#039;|
|`\Stripe\Quote::STATUS_OPEN`||&#039;open&#039;|
...
```php
public Quote::pdf(callable $readBodyChunkCallable, null|array $params = null, null|array|string $opts = null): mixed
```
...
```php
public Quote::accept(null|array $params = null, null|array|string $opts = null): \Stripe\Quote
```
...
```php
public Quote::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\Quote
```
...
```php
public Quote::finalizeQuote(null|array $params = null, null|array|string $opts = null): \Stripe\Quote
```
...
```php
public static Quote::allComputedUpfrontLineItems(mixed $id, null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\Quote&gt;
```
...
```php
public static Quote::allLineItems(mixed $id, null|array $params = null, null|array|string $opts = null): \Stripe\Collection&lt;\Stripe\Quote&gt;
```
