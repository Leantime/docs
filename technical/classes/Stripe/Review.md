...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Review::OBJECT_NAME`||&#039;review&#039;|
|`\Stripe\Review::REASON_APPROVED`||&#039;approved&#039;|
|`\Stripe\Review::REASON_DISPUTED`||&#039;disputed&#039;|
|`\Stripe\Review::REASON_MANUAL`||&#039;manual&#039;|
|`\Stripe\Review::REASON_REFUNDED`||&#039;refunded&#039;|
|`\Stripe\Review::REASON_REFUNDED_AS_FRAUD`||&#039;refunded_as_fraud&#039;|
|`\Stripe\Review::REASON_RULE`||&#039;rule&#039;|
...
```php
public Review::approve(null|array $params = null, null|array|string $opts = null): \Stripe\Review
```
