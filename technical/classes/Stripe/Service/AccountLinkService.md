---
title: \Stripe\Service\AccountLinkService
footer: false
---
...
* Full name: `\Stripe\Service\AccountLinkService`
...
```php
public AccountLinkService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\AccountLink
```
