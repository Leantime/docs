---
title: \Stripe\Service\BalanceService
footer: false
---
...
* Full name: `\Stripe\Service\BalanceService`
...
```php
public BalanceService::retrieve(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Balance
```
