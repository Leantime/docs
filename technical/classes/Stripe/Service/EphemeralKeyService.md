---
title: \Stripe\Service\EphemeralKeyService
footer: false
---
...
* Full name: `\Stripe\Service\EphemeralKeyService`
...
```php
public EphemeralKeyService::delete(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\EphemeralKey
```
...
```php
public EphemeralKeyService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\EphemeralKey
```
