---
title: \Stripe\Service\FinancialConnections\AccountService
footer: false
---
...
* Full name: `\Stripe\Service\FinancialConnections\AccountService`
...
```php
public AccountService::disconnect(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\FinancialConnections\Account
```
...
```php
public AccountService::refresh(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\FinancialConnections\Account
```
...
```php
public AccountService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\FinancialConnections\Account
```
