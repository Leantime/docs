---
title: \Stripe\Service\FinancialConnections\FinancialConnectionsServiceFactory
footer: false
---
...
* Full name: `\Stripe\Service\FinancialConnections\FinancialConnectionsServiceFactory`
...
```php
protected FinancialConnectionsServiceFactory::getServiceClass(mixed $name): null|string
```
