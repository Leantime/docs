---
title: \Stripe\Service\FinancialConnections\SessionService
footer: false
---
...
* Full name: `\Stripe\Service\FinancialConnections\SessionService`
...
```php
public SessionService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\FinancialConnections\Session
```
...
```php
public SessionService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\FinancialConnections\Session
```
