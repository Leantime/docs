---
title: \Stripe\Service\InvoiceItemService
footer: false
---
...
* Full name: `\Stripe\Service\InvoiceItemService`
...
```php
public InvoiceItemService::all(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Collection&lt;\Stripe\InvoiceItem&gt;
```
...
```php
public InvoiceItemService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\InvoiceItem
```
...
```php
public InvoiceItemService::delete(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\InvoiceItem
```
...
```php
public InvoiceItemService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\InvoiceItem
```
...
```php
public InvoiceItemService::update(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\InvoiceItem
```
