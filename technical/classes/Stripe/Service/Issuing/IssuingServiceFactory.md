---
title: \Stripe\Service\Issuing\IssuingServiceFactory
footer: false
---
...
* Full name: `\Stripe\Service\Issuing\IssuingServiceFactory`
...
```php
protected IssuingServiceFactory::getServiceClass(mixed $name): null|string
```
