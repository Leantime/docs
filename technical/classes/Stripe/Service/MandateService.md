---
title: \Stripe\Service\MandateService
footer: false
---
...
* Full name: `\Stripe\Service\MandateService`
...
```php
public MandateService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Mandate
```
