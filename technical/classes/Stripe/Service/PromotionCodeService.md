---
title: \Stripe\Service\PromotionCodeService
footer: false
---
...
* Full name: `\Stripe\Service\PromotionCodeService`
...
```php
public PromotionCodeService::all(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Collection&lt;\Stripe\PromotionCode&gt;
```
...
```php
public PromotionCodeService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\PromotionCode
```
...
```php
public PromotionCodeService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\PromotionCode
```
...
```php
public PromotionCodeService::update(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\PromotionCode
```
