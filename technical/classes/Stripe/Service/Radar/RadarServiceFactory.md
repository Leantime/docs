---
title: \Stripe\Service\Radar\RadarServiceFactory
footer: false
---
...
* Full name: `\Stripe\Service\Radar\RadarServiceFactory`
...
```php
protected RadarServiceFactory::getServiceClass(mixed $name): null|string
```
