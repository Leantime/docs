---
title: \Stripe\Service\Reporting\ReportRunService
footer: false
---
...
* Full name: `\Stripe\Service\Reporting\ReportRunService`
...
```php
public ReportRunService::all(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Collection&lt;\Stripe\Reporting\ReportRun&gt;
```
...
```php
public ReportRunService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Reporting\ReportRun
```
...
```php
public ReportRunService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Reporting\ReportRun
```
