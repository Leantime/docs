---
title: \Stripe\Service\Reporting\ReportingServiceFactory
footer: false
---
...
* Full name: `\Stripe\Service\Reporting\ReportingServiceFactory`
...
```php
protected ReportingServiceFactory::getServiceClass(mixed $name): null|string
```
