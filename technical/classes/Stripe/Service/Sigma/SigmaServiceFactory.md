---
title: \Stripe\Service\Sigma\SigmaServiceFactory
footer: false
---
...
* Full name: `\Stripe\Service\Sigma\SigmaServiceFactory`
...
```php
protected SigmaServiceFactory::getServiceClass(mixed $name): null|string
```
