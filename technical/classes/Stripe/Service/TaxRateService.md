---
title: \Stripe\Service\TaxRateService
footer: false
---
...
* Full name: `\Stripe\Service\TaxRateService`
...
```php
public TaxRateService::all(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Collection&lt;\Stripe\TaxRate&gt;
```
...
```php
public TaxRateService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\TaxRate
```
...
```php
public TaxRateService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\TaxRate
```
...
```php
public TaxRateService::update(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\TaxRate
```
