---
title: \Stripe\Service\Terminal\ConnectionTokenService
footer: false
---
...
* Full name: `\Stripe\Service\Terminal\ConnectionTokenService`
...
```php
public ConnectionTokenService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\ConnectionToken
```
