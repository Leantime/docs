---
title: \Stripe\Service\Terminal\LocationService
footer: false
---
...
* Full name: `\Stripe\Service\Terminal\LocationService`
...
```php
public LocationService::all(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Collection&lt;\Stripe\Terminal\Location&gt;
```
...
```php
public LocationService::create(null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\Location
```
...
```php
public LocationService::delete(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\Location
```
...
```php
public LocationService::retrieve(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\Location
```
...
```php
public LocationService::update(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\Location
```
