---
title: \Stripe\Service\TestHelpers\RefundService
footer: false
---
...
* Full name: `\Stripe\Service\TestHelpers\RefundService`
...
```php
public RefundService::expire(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Refund
```
