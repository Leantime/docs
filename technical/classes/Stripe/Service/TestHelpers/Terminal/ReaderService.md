---
title: \Stripe\Service\TestHelpers\Terminal\ReaderService
footer: false
---
...
* Full name: `\Stripe\Service\TestHelpers\Terminal\ReaderService`
...
```php
public ReaderService::presentPaymentMethod(string $id, null|array $params = null, null|array|\Stripe\Util\RequestOptions $opts = null): \Stripe\Terminal\Reader
```
