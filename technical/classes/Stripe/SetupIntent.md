...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\SetupIntent::OBJECT_NAME`||&#039;setup_intent&#039;|
|`\Stripe\SetupIntent::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\SetupIntent::STATUS_PROCESSING`||&#039;processing&#039;|
|`\Stripe\SetupIntent::STATUS_REQUIRES_ACTION`||&#039;requires_action&#039;|
|`\Stripe\SetupIntent::STATUS_REQUIRES_CONFIRMATION`||&#039;requires_confirmation&#039;|
|`\Stripe\SetupIntent::STATUS_REQUIRES_PAYMENT_METHOD`||&#039;requires_payment_method&#039;|
|`\Stripe\SetupIntent::STATUS_SUCCEEDED`||&#039;succeeded&#039;|
...
```php
public SetupIntent::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\SetupIntent
```
...
```php
public SetupIntent::confirm(null|array $params = null, null|array|string $opts = null): \Stripe\SetupIntent
```
...
```php
public SetupIntent::verifyMicrodeposits(null|array $params = null, null|array|string $opts = null): \Stripe\SetupIntent
```
