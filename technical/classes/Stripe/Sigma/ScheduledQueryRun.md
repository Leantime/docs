---
title: \Stripe\Sigma\ScheduledQueryRun
footer: false
---
...
* Full name: `\Stripe\Sigma\ScheduledQueryRun`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Sigma\ScheduledQueryRun::OBJECT_NAME`||&#039;scheduled_query_run&#039;|
...
```php
public static ScheduledQueryRun::classUrl(): string
```
