---
title: \Stripe\SingletonApiResource
footer: false
---
...
* Full name: `\Stripe\SingletonApiResource`
...
```php
protected static SingletonApiResource::_singletonRetrieve(mixed $options = null): mixed
```
...
```php
public static SingletonApiResource::classUrl(): string
```
...
the endpoint associated with this singleton class
...
```php
public SingletonApiResource::instanceUrl(): string
```
