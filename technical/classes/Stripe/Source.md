...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Source::OBJECT_NAME`||&#039;source&#039;|
|`\Stripe\Source::FLOW_CODE_VERIFICATION`||&#039;code_verification&#039;|
|`\Stripe\Source::FLOW_NONE`||&#039;none&#039;|
|`\Stripe\Source::FLOW_RECEIVER`||&#039;receiver&#039;|
|`\Stripe\Source::FLOW_REDIRECT`||&#039;redirect&#039;|
|`\Stripe\Source::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Source::STATUS_CHARGEABLE`||&#039;chargeable&#039;|
|`\Stripe\Source::STATUS_CONSUMED`||&#039;consumed&#039;|
|`\Stripe\Source::STATUS_FAILED`||&#039;failed&#039;|
|`\Stripe\Source::STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Source::USAGE_REUSABLE`||&#039;reusable&#039;|
|`\Stripe\Source::USAGE_SINGLE_USE`||&#039;single_use&#039;|
...
```php
public Source::detach(null|array $params = null, null|array|string $opts = null): \Stripe\Source
```
...
```php
public Source::sourceTransactions(null|array $params = null, null|array|string $opts = null): \Stripe\Collection
```
...
the list of source transactions
...
```php
public static Source::allSourceTransactions(string $id, null|array $params = null, null|array|string $opts = null): \Stripe\Collection
```
...
```php
public Source::verify(null|array $params = null, null|array|string $opts = null): \Stripe\Source
```
