...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Subscription::OBJECT_NAME`||&#039;subscription&#039;|
|`\Stripe\Subscription::PAYMENT_BEHAVIOR_ALLOW_INCOMPLETE`||&#039;allow_incomplete&#039;|
|`\Stripe\Subscription::PAYMENT_BEHAVIOR_DEFAULT_INCOMPLETE`||&#039;default_incomplete&#039;|
|`\Stripe\Subscription::PAYMENT_BEHAVIOR_ERROR_IF_INCOMPLETE`||&#039;error_if_incomplete&#039;|
|`\Stripe\Subscription::PAYMENT_BEHAVIOR_PENDING_IF_INCOMPLETE`||&#039;pending_if_incomplete&#039;|
|`\Stripe\Subscription::PRORATION_BEHAVIOR_ALWAYS_INVOICE`||&#039;always_invoice&#039;|
|`\Stripe\Subscription::PRORATION_BEHAVIOR_CREATE_PRORATIONS`||&#039;create_prorations&#039;|
|`\Stripe\Subscription::PRORATION_BEHAVIOR_NONE`||&#039;none&#039;|
|`\Stripe\Subscription::STATUS_ACTIVE`||&#039;active&#039;|
|`\Stripe\Subscription::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Subscription::STATUS_INCOMPLETE`||&#039;incomplete&#039;|
|`\Stripe\Subscription::STATUS_INCOMPLETE_EXPIRED`||&#039;incomplete_expired&#039;|
|`\Stripe\Subscription::STATUS_PAST_DUE`||&#039;past_due&#039;|
|`\Stripe\Subscription::STATUS_TRIALING`||&#039;trialing&#039;|
|`\Stripe\Subscription::STATUS_UNPAID`||&#039;unpaid&#039;|
...
```php
public static Subscription::getSavedNestedResources(): \Stripe\Util\Set
```
...
```php
public Subscription::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\Subscription
```
...
```php
public Subscription::deleteDiscount(null|array $params = null, null|array|string $opts = null): \Stripe\Subscription
```
...
```php
public static Subscription::search(null|array $params = null, null|array|string $opts = null): \Stripe\SearchResult&lt;\Stripe\Subscription&gt;
```
