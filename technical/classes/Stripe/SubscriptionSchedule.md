---
title: \Stripe\SubscriptionSchedule
footer: false
---
...
* Full name: `\Stripe\SubscriptionSchedule`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\SubscriptionSchedule::OBJECT_NAME`||&#039;subscription_schedule&#039;|
...
```php
public SubscriptionSchedule::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\SubscriptionSchedule
```
...
the canceled subscription schedule
...
```php
public SubscriptionSchedule::release(null|array $params = null, null|array|string $opts = null): \Stripe\SubscriptionSchedule
```
...
the released subscription schedule
