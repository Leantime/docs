...
* Full name: `\Stripe\Terminal\Reader`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Terminal\Reader::OBJECT_NAME`||&#039;terminal.reader&#039;|
...
```php
public Reader::cancelAction(null|array $params = null, null|array|string $opts = null): \Stripe\Terminal\Reader
```
...
```php
public Reader::processPaymentIntent(null|array $params = null, null|array|string $opts = null): \Stripe\Terminal\Reader
```
...
```php
public Reader::processSetupIntent(null|array $params = null, null|array|string $opts = null): \Stripe\Terminal\Reader
```
...
```php
public Reader::setReaderDisplay(null|array $params = null, null|array|string $opts = null): \Stripe\Terminal\Reader
```
