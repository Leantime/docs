---
title: \Stripe\TestHelpers\TestClock
footer: false
---
...
* Full name: `\Stripe\TestHelpers\TestClock`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\TestHelpers\TestClock::OBJECT_NAME`||&#039;test_helpers.test_clock&#039;|
|`\Stripe\TestHelpers\TestClock::STATUS_ADVANCING`||&#039;advancing&#039;|
|`\Stripe\TestHelpers\TestClock::STATUS_INTERNAL_FAILURE`||&#039;internal_failure&#039;|
|`\Stripe\TestHelpers\TestClock::STATUS_READY`||&#039;ready&#039;|
...
```php
public TestClock::advance(null|array $params = null, null|array|string $opts = null): \Stripe\TestHelpers\TestClock
```
