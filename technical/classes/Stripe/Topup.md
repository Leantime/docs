...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\Stripe\Topup::OBJECT_NAME`||&#039;topup&#039;|
|`\Stripe\Topup::STATUS_CANCELED`||&#039;canceled&#039;|
|`\Stripe\Topup::STATUS_FAILED`||&#039;failed&#039;|
|`\Stripe\Topup::STATUS_PENDING`||&#039;pending&#039;|
|`\Stripe\Topup::STATUS_REVERSED`||&#039;reversed&#039;|
|`\Stripe\Topup::STATUS_SUCCEEDED`||&#039;succeeded&#039;|
...
```php
public Topup::cancel(null|array $params = null, null|array|string $opts = null): \Stripe\Topup
```
