...
```php
public ApiKey::init(\Leantime\Domain\Projects\Repositories\Projects $projectsRepo, \Leantime\Domain\Users\Repositories\Users $userRepo, \Leantime\Domain\Clients\Repositories\Clients $clientsRepo): mixed
```
