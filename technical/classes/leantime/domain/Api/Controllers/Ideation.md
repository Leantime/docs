...
```php
public Ideation::init(\Leantime\Domain\Projects\Repositories\Projects $projects, \Leantime\Domain\Ideation\Repositories\Ideation $ideationAPIRepo): mixed
```
...
| `ideationAPIRepo` | **\Leantime\Domain\Ideation\Repositories\Ideation** |  |
...
```php
public Ideation::get(mixed $params): mixed
```
...
```php
public Ideation::post(mixed $params): mixed
```
...
```php
public Ideation::patch(mixed $params): mixed
```
...
```php
public Ideation::delete(mixed $params): mixed
```
