---
title: \Leantime\Domain\Calendar\Controllers\AddEvent
footer: false
---
...
* Full name: `\Leantime\Domain\Calendar\Controllers\AddEvent`
...
```php
public AddEvent::post(mixed $params): mixed
```
