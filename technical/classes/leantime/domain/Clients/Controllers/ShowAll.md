---
title: \Leantime\Domain\Clients\Controllers\ShowAll
footer: false
---
...
* Full name: `\Leantime\Domain\Clients\Controllers\ShowAll`
...
```php
public ShowAll::init(\Leantime\Domain\Clients\Repositories\Clients $clientRepo): mixed
```
