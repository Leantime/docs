---
title: \Leantime\Domain\Connector\Controllers\Providers
footer: false
---
...
* Full name: `\Leantime\Domain\Connector\Controllers\Providers`
...
```php
public Providers::get(mixed $params): mixed
```
...
```php
public Providers::post(mixed $params): mixed
```
