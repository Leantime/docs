---
title: \Leantime\Domain\Cron\Controllers\Run
footer: false
---
...
* Full name: `\Leantime\Domain\Cron\Controllers\Run`
...
```php
public Run::init(\Leantime\Domain\Cron\Services\Cron $cronSvc): mixed
```
...
|-----------|------|-------------|
| `cronSvc` | **\Leantime\Domain\Cron\Services\Cron** |  |
