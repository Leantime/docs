---
title: \Leantime\Domain\Ideas\Controllers\AdvancedBoards
footer: false
---
...
* Full name: `\Leantime\Domain\Ideas\Controllers\AdvancedBoards`
...
```php
public AdvancedBoards::init(\Leantime\Domain\Ideas\Repositories\Ideas $ideaRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
...
```php
public AdvancedBoards::run(): mixed
```
