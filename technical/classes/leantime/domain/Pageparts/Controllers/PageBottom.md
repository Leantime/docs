---
title: \Leantime\Domain\Pageparts\Controllers\PageBottom
footer: false
---
...
* Full name: `\Leantime\Domain\Pageparts\Controllers\PageBottom`
...
```php
public PageBottom::init(\Leantime\Core\AppSettings $appSettings): mixed
```
