---
title: \Leantime\Domain\Plugins\Controllers\Show
footer: false
---
...
* Full name: `\Leantime\Domain\Plugins\Controllers\Show`
...
```php
public Show::init(\Leantime\Domain\Plugins\Services\Plugins $pluginService): mixed
```
