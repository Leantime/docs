...
```php
public DuplicateProject::init(\Leantime\Domain\Projects\Repositories\Projects $projectRepo, \Leantime\Domain\Clients\Repositories\Clients $clientRepo, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
...
```php
public DuplicateProject::get(): mixed
```
...
```php
public DuplicateProject::post(mixed $params): mixed
```
