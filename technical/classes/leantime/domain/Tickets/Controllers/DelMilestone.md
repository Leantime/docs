...
```php
public DelMilestone::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService): mixed
```
...
```php
public DelMilestone::post(mixed $params): mixed
```
