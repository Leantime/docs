...
```php
public MoveTicket::init(\Leantime\Domain\Tickets\Services\Tickets $ticketService, \Leantime\Domain\Projects\Services\Projects $projectService): mixed
```
...
```php
public MoveTicket::get(mixed $params): mixed
```
...
```php
public MoveTicket::post(mixed $params): mixed
```
