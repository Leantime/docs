---
title: \Leantime\Domain\Tickets\Controllers\ShowAllMilestonesOverview
footer: false
---

# ShowAllMilestonesOverview

Controller Class - Base class For all controllers



* Full name: `\Leantime\Domain\Tickets\Controllers\ShowAllMilestonesOverview`
...
```php
public ShowAllMilestonesOverview::get(mixed $params): mixed
```
