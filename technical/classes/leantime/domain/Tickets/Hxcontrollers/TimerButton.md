---
title: \Leantime\Domain\Tickets\Hxcontrollers\TimerButton
footer: false
---
...
```php
public TimerButton::init(\Leantime\Domain\Timesheets\Services\Timesheets $timesheetService): void
```
...
```php
public TimerButton::getStatus(): mixed
```
