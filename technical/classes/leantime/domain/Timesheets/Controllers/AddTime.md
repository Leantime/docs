...
```php
public AddTime::init(\Leantime\Domain\Timesheets\Repositories\Timesheets $timesheetsRepo, \Leantime\Domain\Projects\Repositories\Projects $projects, \Leantime\Domain\Tickets\Repositories\Tickets $tickets): mixed
```
