...
```php
public Import::init(\Leantime\Domain\Users\Repositories\Users $userRepo, \Leantime\Domain\Ldap\Services\Ldap $ldapService): mixed
```
...
```php
public Import::post(mixed $params): mixed
```
