...
```php
public ShowAll::init(\Leantime\Domain\Users\Repositories\Users $userRepo, \Leantime\Domain\Ldap\Services\Ldap $ldapService): mixed
```
...
```php
public ShowAll::post(mixed $params): mixed
```
