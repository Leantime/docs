...
```php
public ArticleDialog::init(\Leantime\Domain\Wiki\Services\Wiki $wikiService, \Leantime\Domain\Tickets\Services\Tickets $ticketService): mixed
```
...
```php
public ArticleDialog::get(mixed $params): mixed
```
...
```php
public ArticleDialog::post(mixed $params): mixed
```
