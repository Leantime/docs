---
title: \Leantime\Domain\Wiki\Controllers\Show
footer: false
---
...
* Full name: `\Leantime\Domain\Wiki\Controllers\Show`
...
```php
public Show::init(\Leantime\Domain\Wiki\Services\Wiki $wikiService, \Leantime\Domain\Comments\Services\Comments $commentService): mixed
```
