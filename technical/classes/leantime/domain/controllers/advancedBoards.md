---
title: \leantime\domain\controllers\advancedBoards
footer: false
---
...
* Full name: `\leantime\domain\controllers\advancedBoards`
...
```php
public advancedBoards::init(): void
```
...
```php
public advancedBoards::run(): void
```
