---
title: \leantime\domain\controllers\canvas\delCanvasItem
footer: false
---
...
* Full name: `\leantime\domain\controllers\canvas\delCanvasItem`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\leantime\domain\controllers\canvas\delCanvasItem::CANVAS_NAME`||&#039;??&#039;|
...
```php
public delCanvasItem::init(): void
```
