---
title: \leantime\domain\controllers\canvas\editCanvasComment
footer: false
---
...
* Full name: `\leantime\domain\controllers\canvas\editCanvasComment`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\leantime\domain\controllers\canvas\editCanvasComment::CANVAS_NAME`||&#039;??&#039;|
...
```php
public editCanvasComment::init(): void
```
