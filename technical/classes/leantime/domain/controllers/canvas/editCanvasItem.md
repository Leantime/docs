---
title: \leantime\domain\controllers\canvas\editCanvasItem
footer: false
---
...
* Full name: `\leantime\domain\controllers\canvas\editCanvasItem`
...
| Constant | Type | Value |
|:---      |:---  |:---   |
|`\leantime\domain\controllers\canvas\editCanvasItem::CANVAS_NAME`||&#039;??&#039;|
...
```php
public editCanvasItem::init(): void
```
