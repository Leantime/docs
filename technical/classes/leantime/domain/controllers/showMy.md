---
title: \leantime\domain\controllers\showMy
footer: false
---
...
* Full name: `\leantime\domain\controllers\showMy`
...
```php
public showMy::saveTimeSheet(mixed $postData): mixed
```
