---
title: \leantime\domain\controllers\showMyCalendar
footer: false
---
...
* Full name: `\leantime\domain\controllers\showMyCalendar`
...
```php
public showMyCalendar::init(): void
```
...
```php
public showMyCalendar::run(): void
```
