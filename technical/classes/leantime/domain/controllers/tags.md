---
title: \leantime\domain\controllers\tags
footer: false
---
...
* Full name: `\leantime\domain\controllers\tags`
...
```php
public tags::get(mixed $params): mixed
```
...
```php
public tags::post(mixed $params): mixed
```
...
```php
public tags::patch(mixed $params): mixed
```
...
```php
public tags::delete(mixed $params): mixed
```
